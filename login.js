...
let usernameEmailInput = document.getElementById("username-email-login-input")
...
submitButton.addEventListener('click', (e) => {
    ...
    let usernameEmail = usernameEmailInput.value;
    let password = passwordInput.value;

    if (usernameEmail === '' || password === '') {
        errorMessage.innerText = 'Fill in both spaces';
